...
server.on('update', function (addr) {
  if (!argv.quiet) console.log('update: ' + '时间' + (new Date()).toLocaleTimeString()+"  "+ addr)
})
server.on('complete', function (addr) {
  if (!argv.quiet) console.log('complete: '+ '时间' + (new Date()).toLocaleTimeString()+"  "+ addr)
})
server.on('start', function (addr) {
  if (!argv.quiet) console.log('start: ' + '时间' + (new Date()).toLocaleTimeString() +"  "+ addr)
})
