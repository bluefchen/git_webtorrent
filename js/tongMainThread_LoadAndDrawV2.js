...
$(function(){
    ...
    var modelDataM = [];
    var modelDataNewN = [];
    var vsgData = [],vsgArr=[],packageArr=[],packageTag=0,datNum=0;
    ...
    workerDout.onmessage = function (event) {
        ...
        {
            if(vsgArr.indexOf(Data.nam)!=-1)
            {
                packageArr.push(Data.nam);
            }
